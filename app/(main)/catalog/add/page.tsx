...
import Form from '@/app/ui/catalog/add-form';
...
export default async function Page() {
  ...
  return (
    <main className="relative flex flex-col items-center gap-5 px-3 pb-10">
      ...
      {/* Desktop */}
      <section className="max-width flex items-center justify-between gap-40 rounded-[32px] border-[1px] border-accent-light px-[42px] py-[28px] max-lg:hidden"></section>

      {/* Mobile */}
      <div className="flex w-11/12 flex-col items-center gap-6">
        <Form token={token} />
      </div>
    </main>
  );
